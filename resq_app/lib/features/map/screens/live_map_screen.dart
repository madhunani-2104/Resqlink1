  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Refresh location and map',
            onPressed: () async {
              await mapProvider.refreshLocationAndLayers();
      ...
      body: RefreshIndicator(
        onRefresh: mapProvider.refreshLocationAndLayers,
        child: Stack(
          children: [
            FlutterMap(
              ...
              children: [
                ...
                if (mapProvider.safeZones.isNotEmpty)
                  CircleLayer(
                ...
                MarkerLayer(
                  markers: [
                    if (mapProvider.currentLocation.latitude != 0.0 ||
                        mapProvider.currentLocation.longitude != 0.0)
                      Marker(
                    ...
                    if (mapProvider.shelters.isNotEmpty)
                    ...
                    if (mapProvider.victims.isNotEmpty)
