...
class MeshChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final broadcastMessageCount = chatProvider.messages
        .where((message) => message.receiverId == 'BROADCAST')
        .length;
    final respondersOpsMessageCount = chatProvider.messages
        .where((message) => message.receiverId == 'RESPONDERS_OPS')
        .length;
            ...
            child: ListView(
              ...
              children: [
                _buildChannelCard(
                  ...
                  badgeText: '$broadcastMessageCount msgs',
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                ...
                _buildChannelCard(
                  ...
                  badgeText: '$respondersOpsMessageCount msgs',
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
